<%-- 
    Document   : laporanNasabah
    Created on : Aug 26, 2018, 4:27:12 PM
    Author     : budiarti
--%>
...
//        Connection test = null;
        try{        
            ...
            File reportFile = new File(application.getRealPath("nasabahReport.jasper"));//your report_name.jasper file
