<%-- 
    Document   : laporanBarang
    Created on : Aug 26, 2018, 8:26:45 PM
    Author     : budiarti
--%>
...
<html>
    ...
    <body>
        ...
        try{        
            ...
            File reportFile = new File(application.getRealPath("barangReport.jasper"));//your report_name.jasper file
