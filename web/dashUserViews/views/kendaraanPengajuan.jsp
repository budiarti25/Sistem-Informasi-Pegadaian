<%-- 
    Document   : kendaraanPengajuan
    Created on : Aug 26, 2018, 12:01:25 PM
                                            ...
                                            <div class="nav-tabs-wrapper">
                                                ...
                                                <ul class="nav nav-tabs">
                                                    <li class="nav-item col-md-6">
                                                        <a class="nav-link " href="kendaraan.jsp" style="text-align: center">
                                                            Langkah 1
                                                            <div class="ripple-container"></div>
                                                        </a>
                                                    </li>
                                                    <li class="nav-item col-md-6">
                                                        <a class="nav-link active" href="kendaraanPengajuan.jsp" style="text-align: center">
                                                            Langkah 2
                                                            <div class="ripple-container"></div>
                                                        </a>
                                                    </li>
