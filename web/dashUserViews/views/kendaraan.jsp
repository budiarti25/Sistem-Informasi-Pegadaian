<%-- 
    Document   : kendaraan
    Created on : Aug 15, 2018, 8:32:59 AM
                ...
                <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="#">Pengajuan Gadai Kendaraan</a>
                        </div>
                                            ...
                                            <div class="nav-tabs-wrapper">
                                                ...
                                                <ul class="nav nav-tabs" data-tabs="tabs">
                                                    <li class="nav-item col-md-6">
                                                        <a class="nav-link active" href="kendaraan.jsp" style="text-align: center">
                                                            Langkah 1
                                                            <div class="ripple-container"></div>
                                                        </a>
                                                    </li>
                                                    <li class="nav-item col-md-6">
                                                        <a class="nav-link" href="kendaraanPengajuan.jsp" style="text-align: center">
                                                            Langkah 2
                                                            <div class="ripple-container"></div>
                                                        </a>
                                                    </li>
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            <div class="tab-pane active">
                                                <div class="card-body">
                                                    <form method="post" action="kendaraanSave">
