<%-- 
    Document   : laptopPengajuan
    Created on : Aug 26, 2018, 12:01:40 PM
                                            ...
                                            <div class="nav-tabs-wrapper">
                                                ...
                                                <ul class="nav nav-tabs">
                                                    <li class="nav-item col-md-6">
                                                        <a class="nav-link " href="laptop.jsp" style="text-align: center">
                                                            Langkah 1
                                                            <div class="ripple-container"></div>
                                                        </a>
                                                    </li>
                                                    <li class="nav-item col-md-6">
                                                        <a class="nav-link active" href="laptopPengajuan.jsp" style="text-align: center">
                                                            Langkah 2
                                                            <div class="ripple-container"></div>
                                                        </a>
                                                    </li>
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            <div class="tab-pane active">
                                                <div class="card-body">
                                                    <form method="post" action="../../PengajuanLaptop">
