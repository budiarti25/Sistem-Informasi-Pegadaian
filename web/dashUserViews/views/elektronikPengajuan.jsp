<%-- 
    Document   : elektronikPengajuan
    Created on : Aug 26, 2018, 12:00:43 PM
                ...
                <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="#">Pengajuan Gadai Elektronik</a>
                        </div>
                                            ...
                                            <div class="nav-tabs-wrapper">
                                                ...
                                                <ul class="nav nav-tabs">
                                                    <li class="nav-item col-md-6">
                                                        <a class="nav-link " href="elektronik.jsp" style="text-align: center">
                                                            Langkah 1
                                                            <div class="ripple-container"></div>
                                                        </a>
                                                    </li>
                                                    <li class="nav-item col-md-6">
                                                        <a class="nav-link active" href="handphonePengajuan.jsp" style="text-align: center">
                                                            Langkah 2
                                                            <div class="ripple-container"></div>
                                                        </a>
                                                    </li>
